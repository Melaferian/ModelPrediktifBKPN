...
mean_sp3n = 31205100 
std_sp3n = 402211100  
mean_usia_bkpn = 5.134856  
std_usia_bkpn = 5.531027  
mean_jarak_ke_kpknl = 26.360266  
std_jarak_ke_kpknl = 73.307533  
...
def get_user_input():
    ...
    # Determine kelompok_piutang based on the value of SP3N
    if sp3n < 50000000:
        kelompok_piutang = 0
    elif 50000000 <= sp3n < 250000000:
        kelompok_piutang = 1
    elif 250000000 <= sp3n < 1000000000:
        kelompok_piutang = 2
    elif 1000000000 <= sp3n < 5000000000:
        kelompok_piutang = 3
    else:
        kelompok_piutang = 4
    ...
    user_input = np.array([[
        sp3n, usia_bkpn, jarak_ke_kpknl, kelompok_piutang,
        kpknl_serang, kpknl_tangerang_i, kpknl_tangerang_ii,
        kred_bl_non_kemenkeu, kred_bumn_non_perbankan, kred_djbc, kred_eks_blbi,
        kred_pemda, kred_pp_non_kemenkeu, kred_perbankan, kred_rumah_sakit,
        kred_stan, kred_sekjen_kemenkeu, terima_tw_i, terima_tw_ii,
        terima_tw_iii, terima_tw_iv
    ]])
    return user_input

st.title('Pemodelan Prediktif untuk Penentuan Status Akhir BKPN: Lunas atau PSBDT')
...
if st.sidebar.button('Predict'):
    ...
    st.write('Hasil Prediksi:', prediction_text)